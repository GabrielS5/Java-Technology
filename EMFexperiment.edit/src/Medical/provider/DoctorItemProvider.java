...
/**
 * This is the item provider adapter for a {@link Medical.Doctor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DoctorItemProvider 
	...
	protected void addDateOfBirthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Doctor_dateOfBirth_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Doctor_dateOfBirth_feature", "_UI_Doctor_type"),
				 MedicalPackage.Literals.DOCTOR__DATE_OF_BIRTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
