 ...
 * </p>
 * <ul>
 *   <li>{@link Medical.impl.HospitalImpl#getName <em>Name</em>}</li>
 *   <li>{@link Medical.impl.HospitalImpl#getDoctors <em>Doctors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HospitalImpl extends MinimalEObjectImpl.Container implements Hospital {
	...
	protected EClass eStaticClass() {
		return MedicalPackage.Literals.HOSPITAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MedicalPackage.HOSPITAL__NAME, oldName, name));
	}
	...
	public EList<Doctor> getDoctors() {
		if (doctors == null) {
			doctors = new EObjectContainmentEList<Doctor>(Doctor.class, this, MedicalPackage.HOSPITAL__DOCTORS);
		}
		return doctors;
	}
